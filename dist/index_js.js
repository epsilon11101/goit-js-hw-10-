...
/* harmony export */   "Z": () => (/* binding */ fetchCountries)
/* harmony export */ });
...
/* harmony import */ var _country__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(736);
/* harmony import */ var notiflix__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(533);
...
var restoreELements = function restoreELements() {
  ul.innerHTML = "";
  div.innerHTML = "";
};
function createList(countries) {
  restoreELements();
  var country_list = countries.map(function (country) {
    return "\n            <li><img class=\"flag\" alt=\"\" src=\"".concat(country.flag, "\"> ").concat(country.name, "</li>\n        ");
  }).join("");
...
function createDiv(country) {
  restoreELements();
  div.innerHTML = "\n      <p class=\"country\"> <span ><img class=\"flag\" alt=\"\" src=\"".concat(country.flag, "\" ></span> ").concat(country.name, "</p> \n      <p> <span>Capital:</span>  ").concat(country.capital, " </p>\n      <p> <span>Population: </span> ").concat(country.population, " </p>\n      <p> <span>Languages: </span> ").concat(getLanguages(country.languages), " </p>\n    ");
}
function filterCountry(countries) {
  var len = countries.length;
  if (len > 10) {
    restoreELements();
    notiflix__WEBPACK_IMPORTED_MODULE_1___default().Notify.info("Too many matches found. Please enter a more specific name.");
  } else if (len >= 2 && len <= 10) createList(countries);else {
    restoreELements();
    createDiv(countries[0]);
  }
}
search.addEventListener("input", _.debounce(function (e) {
  var url = "https://restcountries.com/v2/name/".concat(e.target.value);
  if (e.target.value.length > 0) {
    (0,_country__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z)(url).then(function (countries) {
      filterCountry(countries, e.target.value);
    })["catch"](function (error) {
      return notiflix__WEBPACK_IMPORTED_MODULE_1___default().Notify.failure("Oops, there is no country with that name");
    });
  }
}, DEBOUNCE_DELAY));
})();
